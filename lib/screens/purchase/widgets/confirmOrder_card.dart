...
class ConfirmCard extends StatelessWidget {
  cities customerRegion;
  double totalPrice = 0.0;

  ConfirmCard({this.customerRegion , this.totalPrice});
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
          top: SizeConfig.getResponsiveWidth(20.0),
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  new Text(
                    translations.text("ConfirmOrderPage.confirmOrderCard.OrderSummaryText"),
                    style:
            ...
            Column(
              children: <Widget>[
                ...
                CustomListTile(
                  title: translations.text("ConfirmOrderPage.confirmOrderCard.SubTotalText"),
...
//                ),
                CustomListTile(
                  title: translations.text("ConfirmOrderPage.confirmOrderCard.DeliveryFreeText"),
                  value: "${double.parse(freeForCashOfDelivery.toString()).toStringAsFixed(2)}",
                ),
                CustomListTile(
                  title: translations.text("ConfirmOrderPage.confirmOrderCard.ValueAddedTaxText"),
                  value: "${double.parse(taxes.toString()).toStringAsFixed(2)}",
                ),
                CustomListTile(
                  title: translations.text("ConfirmOrderPage.confirmOrderCard.TotalText"),
