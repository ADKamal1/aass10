    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: translations.currentLanguage=='en'?Container(
              margin: EdgeInsets.only(top: 10.0),
              child: Text(translations.text("ContactUsPage.title"),
          ...
          children: <Widget>[
            ...
            (familyDetails.telephone == null)?Container():Center(
              ...
              child: Container(
                ...
                child: Text(translations.text("ContactUsPage.address") + familyDetails.address , style: TextStyle(fontWeight:FontWeight.bold,fontSize: SizeConfig.getResponsiveWidth(15)),),
              ),
            ),Center(
              child:  Container(
                margin: EdgeInsets.only(top: SizeConfig.getResponsiveHeight(70)),
                child: Text(translations.text("ContactUsPage.body"), style: TextStyle(fontSize: SizeConfig.getResponsiveWidth(14)),),
              ),
            ),
