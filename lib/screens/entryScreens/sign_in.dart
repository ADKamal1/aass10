...
import 'package:basket/screens/entryScreens/reset_password.dart';
...
class _SignIn extends State<SignIn>{
  ...
  bool validateAndSave(){
    ...
    if(form.validate()){
      ...
      _showErrorDialog(translations.text("SignInPage.DialogTextValidate"));
      return false;
    }
  }
      ...
      try{
        ...
        if(user.uid!=null){
          Navigator.of(context).push(new MaterialPageRoute(
              builder: (context) =>
              new HomePage(screen:Store(),auth: widget.auth,onSignedOut: widget.onSignedIn,)));
        }
        widget.onSignedIn;
      }
      catch (error) {
        ...
        errorMessage =
        translations.text("SignInPage.DialogEmailAndPasswordValidate");
  ...
  void validateOfempty(String str) {
    _showErrorDialog(translations.text("DialogEmailError.SignInPage"));
  }
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                                ...
                                child: Text(
                                  translations.text("SignInPage.title"),
                                  style: TextStyle(
                                      fontSize:
                      ...
                      child: Material(
                        ...
                        child: TextFormField (
                          ...
                          decoration: new InputDecoration(
                            ...
                            labelText: translations.text("SignInPage.EmailHint"),
...
//                      },
                        ...
                        decoration: new InputDecoration(
                          ...
                          labelText: translations.text("SignInPage.passwordHint"),
                          enabledBorder: const OutlineInputBorder(
                            borderRadius:
                            BorderRadius.all(Radius.circular(30.0)),
                            borderSide: const BorderSide(
...
//        height: _height / 20,
                            ...
                            child: Text(
                              translations.text("SignInPage.LogInButton"),
                              style: TextStyle(
                                color: Colors.white,
                  ...
                  Container(
                      ...
                      child: new FlatButton(
                        ...
                        color: Colors.white,
                        child: new FlatButton(
                          child:Text(translations.text("SignInPage.ForgetPassword"),
                            style: TextStyle(
                 ...
                 Container(
                      ...
                      alignment: Alignment.center,
                      child: Text(translations.text("SignInPage.ORText"),
                        style: TextStyle(
                 ...
                 Container(
                      ...
                      child: new FlatButton(
                        ...
                        shape: new RoundedRectangleBorder(
                            borderRadius: new BorderRadius.circular(5.0)),
                        color: Colors.white,
                        child: new Text(translations.text("SignInPage.DonotHavaAccount"),
                          style: TextStyle(
