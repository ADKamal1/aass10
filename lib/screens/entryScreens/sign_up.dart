...
import 'package:basket/screens/entryScreens/phone_number_confirmation.dart';
...
import '../../phone_verification22.dart';
  ...
  void _showErrorDialog(String message) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(translations.text("SignInPage.DialogText")),
        content: Text(message),
        actions: <Widget>[
          FlatButton(
            child: Text(translations.text("SignInPage.DialogButton")),
            onPressed: () {
...
//              builder: (context) =>
//              new PhoneNumberConfirmation(
//                auth:widget.auth,newCustomerID: userId,
//                onSignedIn: widget.onSignedIn,
//              password:password) ) );
//        }
//        else {
//          _showErrorDialog ( translations.text (
//              "SignUPPage.DialogEmailAndPasswordValidate" ) );
//        }
//      }
//      catch (error) {
//        String errorMessage;
//
//        errorMessage =
//            translations.text ( "SignUPPage.DialogEmailAndPasswordValidate" );
                        ...
                        child:TextFormField(
                          ...
                          validator: (value) {
                            if (value.isEmpty || value.length<4) {
                              return translations.text("SignUPPage.InvalidusernameText");
                            }
                          },
                          ...
                          decoration: new InputDecoration(
                            labelText: translations.text("SignUPPage.usernamelabelText"),
                        ...
                        child:TextFormField(
                          ...
                          validator: (value) {
                            if (value.isEmpty || !value.contains('@')) {
                              return translations.text("SignUPPage.InvalidemailText");
                            }
                          },
                          onSaved: (value) => email= value,
                          decoration: new InputDecoration(
                            labelText: translations.text("SignUPPage.emaillabelText"),
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value.isEmpty || value.length<6) {
                              return translations.text("SignUPPage.InvalidPasswordText");
                            }
                          },
                          ...
                          decoration: new InputDecoration(
                            labelText: translations.text("SignUPPage.PasswordlabelText"),
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if(value != _passtextFieldController.text)
                              return translations.text("SignUPPage.ConfirmPasswordValidate");
                          },
                          onSaved: (value) => confirmPassword= value,
                          //controller: _textFieldController,

                          decoration: new InputDecoration(
                            labelText: translations.text("SignUPPage.Confirmpassword"),
                  ...
                  FadeAnimation(2.2,Container(
                    ...
                    child: RaisedButton(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          translations.text("SignUPPage.LogInButton"),
                          style: TextStyle(
                            color: Colors.white,
                ...
                FadeAnimation(2.3,Container(
                  ...
                  child: new FlatButton(
                    ...
                    child: new FlatButton(
                      ...
                      child:Text(
                        translations.text("SignUPPage.haveAccount"),
                        style: TextStyle(
