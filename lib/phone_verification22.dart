...
//import 'package:postman/generated/l10n.dart';
//import 'package:postman/provider/auth_provider.dart';
import 'package:basket/phone_number_utils.dart';
//
...
//      setState(() => showStatus = 3);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('activate_account'),
        actions: <Widget>[
          FlatButton(
            onPressed: () => Navigator.pop(context),
            child: Text('edit_number'),
  ...
  Widget buildHeader() {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text('you_will_receive_verification_messages_shortly'),
          codeStatus(),
          Column(
            children: <Widget>[
              SizedBox(height: 16),
